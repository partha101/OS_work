...
int syscallcount = 0; //Global variable to count the number of system calls invoked after boot
...
extern uint64 sys_sysinfo(void); // declaration of sysinfo system call
extern uint64 sys_procinfo(void); // declaration of procinfo system call

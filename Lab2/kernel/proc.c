...
// Lab 2
// Split the different schedulers into different methods.

// Declare functions first in order to apply attributes;
void round_robin_scheduler(void) __attribute__((noreturn));
